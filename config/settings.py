...
SECRET_KEY = 'django-insecure-wvcgm_zm-1vn@^9fv8tz&gx4rjeo6rwe%p*-lo^#%6*69@%=-z'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': '135790', # Пароль для этого пользователя
...
# Дополнительные настройки для локальной работы с изображениями
# и другими файлами, которые загружает пользователь
